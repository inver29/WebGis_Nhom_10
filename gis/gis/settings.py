...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "Pharma GIS",
    "site_brand": "Admin Dược Phẩm",
    "welcome_sign": "Đăng nhập hệ thống quản lý dược",
    "copyright": "Nhóm GIS Dược Phẩm",
    "search_model": "myapp.Pharmacy", # Quan trọng: Phải sửa cái này để thanh tìm kiếm admin chạy
    "icons": {
        "auth": "fas fa-users-cog",
        "auth.user": "fas fa-user",
        "auth.Group": "fas fa-users",
        "myapp.Pharmacy": "fas fa-clinic-medical", # Icon mới
    },
